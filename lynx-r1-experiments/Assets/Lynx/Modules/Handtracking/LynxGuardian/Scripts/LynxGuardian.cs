    ...
    public class LynxGuardian : MonoBehaviour
    {
        ...
        public void SetupFloorPosition()
        {
            if (!m_isRunning)
            {
                ...
                // Setup position and instantiate floor helper prefab.
                Vector3 relativePos = Camera.main.transform.position;
                relativePos.y = Camera.main.transform.position.y - 0.5f;
...
#region CAMERA METHODS
        ...
        public void ApplyCameraHeight()
        {
            ...
            Debug.Log($"LynxGuardian - Camera Y Offset loaded, with Height: {Height}");
        }
