...
namespace Lynx
{
    public class LynxHandtrackingEditor
    {
        ...
        public static void AddHandtracking(bool isUnityEvent, bool isDirectInteraction, bool isRaycast, bool handsVisualizer)
        {
        ...
        public class HandtrackingAddWindow : EditorWindow
        {
            ...
            void OnGUI()
            {
                ...
                if (GUILayout.Button("Add"))
                {
                    ...
                    AddHandtracking(cbUnityEvents, cbDirectInteractor, cbRaycasting, cbHandsVisualizer);
                    this.Close();
                }
